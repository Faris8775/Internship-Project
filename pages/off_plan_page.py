...
class OffPlanPage(Page):
    OFF_PLAN = (By.CSS_SELECTOR, '.menu-text-link-leaderboard.w--current')
    # OFF_PLAN = (By.CSS_SELECTOR, '.menu-link.w-inline-block.w--current')
    ...
    # NEXT_PAGE = (By.XPATH, '//div[text()="Next page"]')
